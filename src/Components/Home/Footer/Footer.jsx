...
const socialIcons = [
  ...
  { icon: <Instagram />, color: '#', label: 'instagram', link: 'https://www.instagram.com/code_0sphere/'},
  { icon: <WhatsApp />, color: '#', label: 'whatsapp', link: 'https://wa.me/yourphonenumber'},
  { icon: <Email />, color: '#', label: 'email', link: 'mailto:csphere28@gmail.com' }, 
];
          ...
          <Grid item xs={12} sm={6} md={3}>
            ...
            <Box sx={{ mb: 2 }}>
              ...
              <Box sx={{ display: 'flex', mb: 2 }}>
                ...
                <Link href="mailto:csphere28@gmail.com" sx={{ color: '#adb5bd', textDecoration: 'none' }}>
                  <Typography variant="body2">
                    csphere28@gmail.com
                  </Typography>
                </Link>
