...
const StyledButton = styled(Button)(({ theme }) => ({
  ...
  "&:hover": {
    ...
    background: "linear-gradient(to right, var(--blue--), #0000009f)",
    color:' #fff',
...
export default function TechHiveNavbar( {dashbord}) {
  ...
  const handleLogin = (e) => {
    e.preventDefault();
    if (username === "tarek" && password === "222") {
      setLoginError("");
      ...
      <Box sx={{ p: 2, mt: 1 }}>
        <List>
          {pages.map((page) => {
            ...
            return (
              <StyledListItem key={page.name} disablePadding>
                <StyledListButton
                  selected={isSelected}
                  onClick={() => {
                    navigate(page.path);
    ...
    <div className="cor">
      <HideOnScroll>
        ...
        <img
                    ...
                    alt="Logo"
                    style={{
                      height: "50px", // اضبط حجم الصورة حسب احتياجاتك
                      width: "auto",
                      filter: "drop-shadow(0 2px 4px rgba(0,0,0,0.2))", // لإضافة تأثير الظل مثل النص الأصلي
                    }}
                  />
                </Box>
                <Typography
                  ...
                  sx={{
                    ...
                    fontWeight: 800,
                    // letterSpacing: '.2rem',
                    background: `linear-gradient(135deg, #426dc5 30%, #5dc2bc 100%)`,
              ...
              >
                ...
                >
                  <img
                    ...
                    alt="Logo"
                    style={{
                      height: "35px", // اضبط حجم الصورة حسب احتياجاتك
                      width: "auto",
                      filter: "drop-shadow(0 2px 4px rgba(0,0,0,0.2))", // لإضافة تأثير الظل مثل النص الأصلي
                    }}
                  />
